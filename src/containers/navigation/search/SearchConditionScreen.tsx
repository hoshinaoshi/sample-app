...
const mapDispatchToProps = (dispatch) => {
  return {
    inputPassword: (value) => dispatch(searchConditionScreenModule.inputPassword(value)),
    inputEmail: (value) => dispatch(searchConditionScreenModule.inputEmail(value)),
    selectBirthday: (value) => dispatch(searchConditionScreenModule.selectBirthday(value)),
    selectSex: (value) => dispatch(searchConditionScreenModule.selectSex(value)),
    inputNickname: (value) => dispatch(searchConditionScreenModule.inputNickname(value)),
    selectResidence: (value) => dispatch(searchConditionScreenModule.selectResidence(value)),
    selectPurpose: (value) => dispatch(searchConditionScreenModule.selectPurpose(value)),
    selectAnnualIncome: (value) => dispatch(searchConditionScreenModule.selectAnnualIncome(value)),
    selectOccupation: (value) => dispatch(searchConditionScreenModule.selectOccupation(value)),
    selectHeight: (value) => dispatch(searchConditionScreenModule.selectHeight(value)),
    selectAcademicHistory: (value) => dispatch(searchConditionScreenModule.selectAcademicHistory(value)),
    selectFirstDatingSpendCost: (value) => dispatch(searchConditionScreenModule.selectFirstDatingSpendCost(value)),
    selectPeriodUntilDating: (value) => dispatch(searchConditionScreenModule.selectPeriodUntilDating(value)),
    selectMarriageHistory: (value) => dispatch(searchConditionScreenModule.selectMarriageHistory(value)),
    selectHaveChild: (value) => dispatch(searchConditionScreenModule.selectHaveChild(value)),
    inputSelfIntroduction: (value) => dispatch(searchConditionScreenModule.inputSelfIntroduction(value)),
    pickImage: (value) => dispatch(searchConditionScreenModule.pickImage(value)),

    singUp: (email, password, birthday, sex, nickname, residence, purpose, annual_income, occupation, height, academic_history, first_dating_spend_cost, period_until_dating, marriage_history, have_child, self_introduction, main_image, token, os) => dispatch(searchConditionScreenModule.singUp({email, password, birthday, sex, nickname, residence, purpose, annual_income, occupation, height, academic_history, first_dating_spend_cost, period_until_dating, marriage_history, have_child, self_introduction, main_image, token, os})),
    toggleSearchConditionButton: (value) => dispatch(searchConditionScreenModule.toggleSearchConditionButton(value)),
  }
}

// ログイン判定
class SearchConditionScreen extends React.Component {
 ...
 _onPressSearchCondition(){
    ...
    RNS3.put({uri: this.props.searchCondition.main_image.uri, name: `${directory}${fileName}`, type: "image/jpg"}, options)
      .then(res => {
        if (res.status !== 201){
          error.push(res)
        } else {
          ...
          this.props.singUp(
            this.props.searchCondition.email,
            this.props.searchCondition.password,
            this.props.searchCondition.birthday,
            this.props.searchCondition.sex,
            this.props.searchCondition.nickname,
            this.props.searchCondition.residence,
            this.props.searchCondition.purpose,
            this.props.searchCondition.annual_income,
            this.props.searchCondition.occupation,
            this.props.searchCondition.height,
            this.props.searchCondition.academic_history,
            this.props.searchCondition.first_dating_spend_cost,
            this.props.searchCondition.period_until_dating,
            this.props.searchCondition.marriage_history,
            this.props.searchCondition.have_child,
            this.props.searchCondition.self_introduction,
            fileName,
            "",
            os,
          )
      ...
      <ScrollView pagingEnabled={true} horizontal={true} ref={(snapScroll) => { this.snapScroll = snapScroll; }}>
        <View style={styles.slide}>
          ...
          <TextInput
            ...
            value={this.props.searchCondition.email}
          />
          <TextInput
            ...
            value={this.props.searchCondition.password}
          />
          <DatePicker
            style={{width: 200}}
            date={this.props.searchCondition.birthday}
            mode="date"
          ...
          <TextInput
            ...
            value={this.props.searchCondition.nickname}
          />
          <RNPickerSelect
        ...
        <View style={styles.slide}>
          ...
          />
          {this.props.searchCondition.main_image && <Image source={{ uri: this.props.searchCondition.main_image.uri }} style={{ width: 200, height: 200 }} />}
          <TextInput
            placeholder={"自己紹介"}
            multiline={true}
            style={{borderWidth: 1, borderColor: "black", width: 300, height: 300}}
            onChangeText={text => this.props.inputSelfIntroduction(text)}
            value={this.props.searchCondition.self_introduction}
          />
          <Button
            title="登録"
            onPress={() => this._onPressSearchCondition()}
          />
        </View>
      </ScrollView>
    );
...
export default connect(mapStateToProps, mapDispatchToProps)(SearchConditionScreen);
